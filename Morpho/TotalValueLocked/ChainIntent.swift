...
var AVAILABLE_CHAINS:[ChainDetail] = [
    ChainDetail(id: ChainUtils.getMetadata(.ETH_MAINNET).identifier, blockchainIds: [.ETH_MAINNET], label: "Mainnet"),
    ChainDetail(id: ChainUtils.getMetadata(.BASE_MAINNET).identifier, blockchainIds: [.BASE_MAINNET], label: "Base"),
